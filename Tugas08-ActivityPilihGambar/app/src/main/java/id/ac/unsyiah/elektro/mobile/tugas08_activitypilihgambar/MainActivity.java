...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int[] gambar={R.drawable.mobil, R.drawable.sepeda_motor,R.drawable.becak_motor,R.drawable.becak_dayung, R.drawable.sepeda};
