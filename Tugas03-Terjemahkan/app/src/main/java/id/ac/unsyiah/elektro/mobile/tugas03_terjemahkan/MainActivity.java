...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickEng(View view){
        ...
        String apakabar = getString(R.string.txtEng);
    ...
    public void onClickAceh(View view){
        TextView txtTulisan = (TextView) findViewById(R.id.txtTulisan);
        String apakabar = getString(R.string.txtAceh);
        txtTulisan.setText(apakabar);
        txtAceh = true;
    }
    private boolean txtEng = false;
    private boolean txtInd = false;
    private boolean txtAceh = false;
}
