...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickEnglish(View view) {
        TextView txtTulisan = (TextView) findViewById(R.id.txtTulisan);
            ...
            String apakabar = getString(R.string.TERJEMAHKAN_KE_INGGRIS);
            txtTulisan.setText(apakabar);

    }
    public void onClickIndonesia(View view) {
        TextView txtTulisan = (TextView) findViewById(R.id.txtTulisan);
            String apakabar = getString(R.string.TERJEMAHKAN_KE_INDONESIA);
            txtTulisan.setText(apakabar);
        ...
        String apakabar = getString(R.string.TERJEMAHKAN_KE_ACEH);
        txtTulisan.setText(apakabar);
